...
class Ui_dlgSalir(object):
    def setupUi(self, dlgSalir):
        ...
        self.lblMensalir.setGeometry(QtCore.QRect(0, 50, 371, 31))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        ...
        self.label.setGeometry(QtCore.QRect(180, 10, 41, 41))
        font = QtGui.QFont()
        font.setFamily("Verdana")
